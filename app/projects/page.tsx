            ...
            {[
              ...
              <Reveal key={index} delay={index * 100} direction="up">
                <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg card-hover h-full border border-transparent dark:border-gray-700">
                  ...
                  <div className="p-6">
                    <div className="inline-block px-3 py-1 mb-3 text-xs font-medium bg-agile-blue/10 text-agile-blue dark:bg-agile-blue-dark/10 dark:text-agile-blue-dark rounded-full">
                      {project.category}
                    </div>
                    <h3 className="text-xl font-bold mb-2 dark:text-white">{project.title}</h3>
                    <p className="text-agile-gray dark:text-gray-300 mb-4">{project.description}</p>
                    <Button
                      variant="outline"
                      className="text-agile-blue border-agile-blue hover:bg-agile-blue/10 dark:text-agile-blue-dark dark:border-agile-blue-dark dark:hover:bg-agile-blue-dark/10"
                      size="sm"
                    >
                      View Details
